 ...
 */
public class MethodInfoOld implements Serializable {
    ...
    */
    ...
    public MethodInfoOld(Method method)
    {
        mMethod = method;
        methodReturnType = method.getReturnType();
        methodName = method.getName();
        humanReadableDescription = createHumanReadableDescription();
    }

    private String createHumanReadableDescription()
    {
        String description = methodReturnType.getName() + " " + methodName + " (";
        for(Class<?> parameter:mMethod.getParameterTypes())
        {
